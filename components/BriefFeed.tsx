...
export default function BriefFeed({
  ...
  // mounted flag para activar animaciones solo en el cliente
                ...
                >
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2">
                      {isRead && (
                        <span className="text-neutral-600 text-xs" title="Leído">
                          ✓
                        </span>
                      )}
                    ...
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full border shrink-0 ${badge.className}`}
                    >
                      {badge.label}
                    </span>
                  </div>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <div className="flex flex-wrap items-center gap-2 text-xs text-neutral-500">
                      <span className="text-neutral-600">
                        {formatRelativeTime(event.publishedAt, now)}
                      </span>
      ...
      {selectedEvent && (
        ...
        >
          ...
          >
            ...
            <span
              className={`text-xs px-2 py-0.5 rounded-full border self-start ${importanceBadge(selectedEvent.importance).className}`}
            >
